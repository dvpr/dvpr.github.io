<link rel="stylesheet" type="text/css" href="http://hamodel.com/assets/css/lightgallery.css" />
<style>
    .cont {
        text-align: center;
    }
...
<script type="text/javascript" src="http://hamodel.com/assets/js/jquery-2.1.3.min.js"></script>
<script type="text/javascript" src="http://hamodel.com/assets/js/picturefill-2.3.1.min.js"></script>
<script type="text/javascript" src="http://hamodel.com/assets/js/jquery.mousewheel-3.1.13.min.js"></script>
<script type="text/javascript" src="http://hamodel.com/assets/js/lightgallery-all-1.6.12.min.js"></script>
